  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <header className="relative overflow-hidden pt-16">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-12 py-16 md:py-20 lg:py-28 relative z-10">
          <motion.div
          ...
          >
            ...
            <p className="mt-4 text-base sm:text-lg md:text-xl max-w-3xl mx-auto opacity-90">
              Discover, create and manage campus events — concerts, fairs, tech
              summits and more. Built for students and organizers.
            </p>
            ...
            <div className="mt-8 flex flex-col sm:flex-row justify-center gap-4 items-center">
              <button
                ...
                className="w-full sm:w-auto inline-flex items-center justify-center gap-3 px-6 py-3 rounded-full bg-white text-gray-900 font-semibold shadow-md hover:shadow-lg transition"
              >
              ...
              <button
                ...
                className="w-full sm:w-auto inline-flex items-center justify-center gap-3 px-6 py-3 rounded-full bg-gradient-to-r from-pink-500 to-yellow-400 text-white font-semibold shadow-lg hover:opacity-95 transition"
              >
                Get Started
              </button>
            </div>
            ...
            <div className="mt-10 max-w-3xl mx-auto">
              <div className="bg-white/90 backdrop-blur rounded-full shadow-lg px-4 py-3 flex flex-col sm:flex-row items-stretch sm:items-center gap-3">
                <div className="flex items-center gap-3 flex-1">
                  <FaSearch className="text-gray-400 w-5 h-5 shrink-0" />
                  <input
                    aria-label="Search events"
                    className="flex-1 bg-transparent outline-none placeholder-gray-400 text-gray-800 text-sm sm:text-base"
                    placeholder="Search events, venues or categories..."
                  />
                </div>

                <select className="w-full sm:w-auto bg-transparent outline-none text-sm text-gray-700 border-t sm:border-t-0 sm:border-l border-gray-200 sm:pl-3 pt-2 sm:pt-0">
                ...
                <button
                  onClick={() => router.push("/login")}
                  className="w-full sm:w-auto ml-0 sm:ml-2 inline-flex items-center justify-center gap-2 bg-pink-600 hover:bg-pink-700 px-4 py-2 rounded-full text-white font-semibold"
                >
                  Search
                </button>
              </div>
            ...
            {/* Stats */}
            <div className="mt-10 flex flex-col sm:flex-row justify-center gap-6 sm:gap-8 items-center text-white/90">
      ...
      {/* MAIN */}
      <main className="max-w-7xl mx-auto px-4 sm:px-6 md:px-12 py-12">
        {/* Featured Events */}
        <section className="mb-12">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
            <h2 className="text-xl sm:text-2xl font-bold text-gray-800 flex items-center gap-3">
              <FaStar className="text-pink-500 shrink-0" /> Featured events
            </h2>
            <button
              onClick={() => router.push("/login")}
                ...
                <div className="p-4 flex flex-col gap-3">
                  <div className="flex flex-wrap items-center justify-between gap-2">
                    <div className="flex items-center gap-2 flex-wrap">
                      <span className="inline-flex items-center gap-2 bg-pink-50 text-pink-700 px-3 py-1 rounded-full text-xs sm:text-sm">
                        {ev.tag}
                      </span>
                    ...
                    <div className="flex items-center gap-1 text-xs sm:text-sm text-yellow-600">
                      <FaStar />{" "}
                      <span className="font-semibold">{ev.rating}</span>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center justify-between mt-2 gap-2">
                    <button
                      onClick={() => router.push("/login")}
                      className="flex-1 px-4 py-2 rounded-lg bg-gradient-to-r from-pink-500 to-yellow-400 text-white text-xs sm:text-sm font-semibold shadow-sm hover:opacity-95 transition"
                    >
                      View Details
                    </button>
                    <button
                      onClick={() => router.push("/login")}
                      className="flex-1 px-3 py-2 rounded-lg border border-gray-200 text-xs sm:text-sm text-gray-700 hover:bg-gray-50 transition"
                    >
                      Book
                    </button>
                  </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className="rounded-2xl bg-white shadow-sm p-6 hover:shadow-md transition">
              ...
              <p className="text-sm text-gray-600">
                Create events with an intuitive flow — dates, venues, and
                tickets.
              </p>
            </div>
            ...
            <div className="rounded-2xl bg-white shadow-sm p-6 hover:shadow-md transition">
              ...
              <p className="text-sm text-gray-600">
                Sell, distribute or reserve tickets and use QR for seamless
                check-in.
              </p>
            </div>
            ...
            <div className="rounded-2xl bg-white shadow-sm p-6 hover:shadow-md transition">
              ...
              <p className="text-sm text-gray-600">
                Connect attendees, share event updates and build your campus
                community.
              </p>
            </div>
          </div>
        ...
        <section className="mb-12 flex flex-col md:flex-row gap-6 items-stretch">
          <div className="flex-1 rounded-2xl bg-gradient-to-r from-pink-50 to-yellow-50 p-6 shadow-sm">
            ...
            <p className="text-gray-700 mb-4">
              We help student organizers manage registrations and scale events
              with ease.
            </p>
            <div className="flex flex-wrap gap-3">
              <div className="bg-white rounded-full px-4 py-2 shadow-sm text-sm">
                OAU
              </div>
              <div className="bg-white rounded-full px-4 py-2 shadow-sm text-sm">
                UI
          ...
          <div className="w-full md:w-80 rounded-2xl bg-white p-6 shadow-md flex flex-col justify-between">
            <div>
              <h4 className="text-lg font-semibold text-gray-800 mb-2">
                Start hosting
              </h4>
              <p className="text-sm text-gray-600 mb-4">
                Create your first event and get discovered by thousands of
                students.
              </p>
            </div>
            <div>
      ...
      <footer className="bg-white border-t border-gray-100 py-6">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-12 flex flex-col md:flex-row justify-between items-center gap-4">
