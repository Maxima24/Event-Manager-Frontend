...
const Event = [
  {
    ...
    eventImage:
      "https://www.dreamstime.com/beautiful-summer-spring-meadow-blue-flowers-forget-me-nots-two-flying-butterflies-wild-nature-landscape-beautiful-image182636005",
    eventTIme: "free",
    eventAvailablity: "Free",
  },
  {
...
export function UserSection() {
  ...
  return (
    <div className="mt-10 ">
      ...
      {/*view events */}
      <div className="flex items-center ml-3 mt-2 font-semibold text-2xs ">
            <NavigationSpan name={"all"}/>
            <NavigationSpan name={"Today"}/>
            <NavigationSpan name={"This Weekend"}/>
